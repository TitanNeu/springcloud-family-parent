...
public class KafkaUsingCaseImpl implements KafkaUsingCase {
    ...
    public void consumerFunction() {
        ...
        consumer.subscribe(Collections.singletonList(Params.topic1));
    ...
    public void producerFunction() {
        ...
        for (int i = 0; i < 10; i++)
            producer.send(new ProducerRecord<String, String>(Params.topic1, Integer.toString(i), Integer.toString((int)(i+Math.random()*10))));
